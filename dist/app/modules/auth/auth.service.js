...
const createAuthUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const password = yield bcrypt_1.default.hash(data === null || data === void 0 ? void 0 : data.password, Number(config_1.default.bcrypt_salt_rounds));
...
const loginUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const decryptedPassword = yield bcrypt_1.default.compare(password, isUserExist.password);
    if ((isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.password) && !decryptedPassword) {
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.jwthelper.createToken({ id: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.id, role: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.role }, config_1.default.jwt.secret, {
        expiresIn: config_1.default.jwt.expires_in,
    });
    return {
        accessToken,
